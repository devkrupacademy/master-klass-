...
const FOR_WHOM_LEFT = [
  'У вас є відділ продажів, але менеджери закривають слабше, ніж могли б.',
  'Частина заявок зливається ще до оплати - і ви не розумієте де саме.',
  'Хочете витиснути більше з поточного потоку лідів, а не вкладати більше в рекламу.',
  'Самі закриваєте найважливіші угоди, бо більше нікому довірити.',
];
const FOR_WHOM_RIGHT = [
  'В кінці тижня відкриваєте CRM і бачите 60% від плану, і так щомісяця.',
  'Хочете нарешті зрозуміти чому команда не росте - і що з цим робити.',
  'Хочете автоматизувати контроль менеджерів і перестати вручну слухати дзвінки, щоб ШІ робив це за вас.',
  'Думаєте про масштабування, але спочатку треба «розібратися з командою» - і так уже рік.',
];
...
const PROGRAM = [
  {
    ...
    bullets: [
      'Як порахувати в цифрах скільки грошей ваш відділ зливає щотижня.',
...
const HERO_CHECKS = [
  'Зрозумієте де саме ваша команда зливає угоди',
    ...
    >
      ...
      >
        ...
        <div className="hero-anim hero-anim-d6 absolute" style={{ left: 9, top: 578, width: 343, height: 78 }}>
          ...
          >
            Реєструйтесь протягом <Countdown className="font-semibold" /> хв, та отримайте в подарунок гайд «5 типів менеджерів, які вбивають продажі компанії»
          </div>
        </div>
        </div>
      </div>
...
function MethodologyMobile() {
  return (
    <section className="lg:hidden relative bg-black text-white px-5 py-10">
      ...
      >
        Я покажу вам протестовану методологію, яка допомагає будувати ефективні відділи з продажів та команди, яка драйвить продажі
      </p>
    </section>
  );
}
...
const RESULTS_LEFT = [
  'Зрозумієте чому менеджери не продають і де саме зараз іде злив угод.',
  'Побачите різницю між сильним і слабким менеджером по дзвінках, а не по відчуттях.',
  'Отримаєте покрокову систему навчання команди - можна запустити вже наступного тижня.',
];
const RESULTS_RIGHT = [
  'Дізнаєтесь як контролювати дзвінки автоматично - без ручного прослуховування.',
  'Зрозумієте як побудувати відділ, який продає без вас.',
  'На 2-й день побачите реальні дзвінки і порівняєте з тим, що відбувається у вас зараз.',
];
...
function AndriyStatsMobile() {
  const founders = [
    ...
    'Академія продажів - рекрутинговий та освітній проєкт, який спеціалізується на наймі комерсантів. За 8 років найнято більше 3000 людей та 10 000+ людей навчено продажам',
...
function AndriyStats() {
  ...
  const founderBullets = [
    ...
    },
    {
      left: 401,
      width: 329,
      text: 'Академія продажів - рекрутинговий та освітній проєкт, який спеціалізується на наймі комерсантів. За 8 років найнято більше 3000 людей та 10 000+ людей навчено продажам',
    },
    {
      left: 776,
      width: 181,
...
const TESTIMONIALS = [
  ...
  {
    name: 'Надія Щербина',
    text: 'Привіт!\nДивлюся продажі. Паралельно купа інсайтів по власному контенту що писатиму.\nНу шо сказати, я зробила всі можливі і неможливі помилки у продажах. Андрій був правий мульйон відсотків стосовно того, що мені потрібен саме цей модуль.\nКлючове - я бачу що саме потрібно і під яким соусом, а власники частіше за все не готові слухати і ще не дійшли. І це тільки анамнез. Ото ж мої любимі граблі.\nДозріваю потихеньку, паралельно підтягую психологічні завтики.\nДуже вдячна Богу і собі, що прийшла на цю програму. Контент просто 🔥\nГоршечок, вари ще!',
  },
  {
