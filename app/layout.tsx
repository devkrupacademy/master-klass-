...
export const metadata: Metadata = {
  ...
  description:
    'Живий 2-денний майстермайнд 28–29 квітня. За 2 вечори розберемо ТОП-5 проблем твого відділу продажів і побудуємо систему, яка працює без твого контролю.',
  openGraph: {
    title: 'Майстермайнд Андрія Крупкіна — х2 у продажах у 2026 році',
    description:
      'Живий 2-денний майстермайнд 28–29 квітня. Система продажів, яка працює без твого контролю.',
