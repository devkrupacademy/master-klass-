      ...
      <div className="px-12">
        ...
        <Section title="Display">
          ...
          <Row
            ...
            ls="-0.022em"
            weight="400"
            usage="Заголовки секцій: 'Програма мастермайнду'"
            sample={<h2 className="font-display text-h2 uppercase">Програма мастермайнду</h2>}
          />
          <Row
            token="heading.h3"
        ...
        <Section title="Body">
          <Row
            ...
            ls="-0.011em"
            weight="500"
            usage="Пункти програми мастермайнду"
            sample={
          ...
          <Row
            ...
            sample={<p className="font-sans text-body-lead">Майстермайнд Андрія Крупкіна</p>}
          />
          <Row
            token="body-list"
            ...
            ls="0"
            weight="400"
            usage="Пункти чеклистів ('цей мастермайнд для тебе якщо')"
            sample={
